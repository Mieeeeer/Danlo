    ...
    <div class="profile-wrapper">
        <div class="profile-header">
            <div class="profile-picture">
                <img src="/api/placeholder/120/120" alt="Student Profile Picture" width="100%" height="100%">
            </div>
            <h1 class="profile-name">John Doe</h1>
            <div class="profile-id">Student LRN: 12345689</div>
        </div>
        ...
        <div class="profile-details">
            ...
            <div class="detail-item">
                ...
                <div class="value">john.doe@university.edu</div>
            </div>
            <div class="detail-item">
